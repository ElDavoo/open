...
###############################################################################
# TEST: User has an "Affiliate" Role in any secondary Account that it happens
...
###############################################################################
# TEST: User is "Member" of a WS, giving them an Affiliate Role in the WS's
...
# the Account downgrades its "Member" Role to "Affiliate" (because the User
