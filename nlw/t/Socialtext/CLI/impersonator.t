...
remove_workspace_impersonator: {
    ...
    expect_success(
        ...
        qr/$username no longer has the role of 'impersonator' in the $ws_name Workspace/,
...
remove_member_as_workspace_impersonator: {
    ...
    expect_failure(
        ...
        qr/$username does not have the role of 'impersonator' in the $ws_name Workspace/,
